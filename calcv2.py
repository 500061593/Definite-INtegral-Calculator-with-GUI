...
def call_result(label_result, n1, n2,n3):
	try:
		...
		labelNum = tk.Label(root, text="                                  ").grid(row=9, column=0)
		labelNumz = tk.Label(root, text="                                                           ").grid(row=10, column=0)
		return  
	except:
		labelNum = tk.Label(root, text="Incorrect entry,").grid(row=9, column=0)
		labelNumz = tk.Label(root, text="Please check your expression").grid(row=10, column=0)
